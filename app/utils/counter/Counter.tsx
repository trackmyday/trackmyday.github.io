...
export default function Counter() {
  ...
  return (
    <button
      type="button"
      onClick={increment}
      className="relative min-h-screen w-full overflow-hidden bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100"
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center gap-5 px-6 text-center">
        ...
        <p className="text-7xl font-bold tracking-tight md:text-8xl">{count}</p>
